...
export default function Navbar() {
  ...
  return (
    <>
    <nav
        className={`navbar bg-white flex flex-row justify-between py-2 px-6 lg:px-34 items-center fixed top-0 left-0 w-full z-50 transition-shadow duration-300 ${
          scroll ? "shadow-xl" : ""
        }`}
      >
        <Link>
        ...
        <ul className="hidden md:flex flex-row justify-between space-x-10">
          ...
          <li>
            <NavLink to="/arrivals" className="font-semibold">
              New Arrivals
            </NavLink>
          </li>
          <li>
          ...
          <li>
            <NavLink to="/help" className="font-semibold">
              Help
            </NavLink>
          </li>
          <li>
