  ...
  return (
    <div className="px-8 lg:px-34 md:px-30 py-40">
      ...
      {cartItems.length === 0 ? (
        ...
        <>
        <div>
        <h1 className="text-3xl font-bold mb-8 text-purpla text-start mb-10 ">Your Shopping Cart</h1>
        ...
        <div className="w-full px-4 md:px-10 shadow-sm bg-white py-10 rounded-xl"> 
          {cartItems.map((item) => (
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                />
                <div>
                  <h2 className="font-bold text-lg w-80">{item.product.title}</h2>
          ...
          <div className="flex justify-between items-center mt-10 px-20">
            ...
            <h3 className="text-2xl font-bold text-purpla">${total.toLocaleString(undefined, {maximumFractionDigits : 2, minimumFractionDigits: 2})}</h3>
          </div>
